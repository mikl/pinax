...
urlpatterns = patterns('',
        ...
        url(r'^task/(?P<id>\d+)/observe/$', 'tasks.views.task_observe', name="task_observe"),
        url(r'^task/(?P<id>\d+)/observe/stop/$', 'tasks.views.task_observe_stop', name="task_observe_stop"),
